...
exports.default = countFilter;
function countFilter(arr, value) {
...
var _httpGet = __webpack_require__(/*! ./httpGet */ "./src/httpGet.js");

var _httpGet2 = _interopRequireDefault(_httpGet);

var _stringFilter = __webpack_require__(/*! ./stringFilter */ "./src/stringFilter.js");

var _stringFilter2 = _interopRequireDefault(_stringFilter);

var _countFilter = __webpack_require__(/*! ./countFilter */ "./src/countFilter.js");

var _countFilter2 = _interopRequireDefault(_countFilter);

__webpack_require__(/*! ./style/style.scss */ "./src/style/style.scss");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var url = 'https://cors.io/?http://www.mrsoft.by/data.json';
var inputElement = document.querySelector('.inputValue');
var registr = document.querySelector('.registr');
var buttonCount = document.querySelector('.btnCount');
var buttonString = document.querySelector('.btnString');
...
(0, _httpGet2.default)(url).then(function (response) {
    return info = JSON.parse(response);
...
var paintList = function paintList(arr, value) {
    list.innerHTML = '';
...
buttonString.addEventListener('click', function (e) {
    var inputNum = inputElement.value;
    note.textContent = '';
    if (isNaN(inputNum) || !inputNum.length) {
        var _result = (0, _stringFilter2.default)(info.data, inputElement.value, registr.checked);
        paintList(_result, inputElement.value);
    } else {
...
buttonCount.addEventListener('click', function (e) {
    ...
    note.textContent = '';
    if (!isNaN(inputNum)) {
        var _result2 = (0, _countFilter2.default)(info.data, inputNum);
        paintList(_result2, inputNum);
    } else {
...
function stringFilter(arr, value, registr) {
